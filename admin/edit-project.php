...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE projects SET title = ?, client = ?, contract_sum = ?, completion_year = ?, completion_month = ?, status = ?, eot = ?, eot_number = ?, eot_month = ?, eot_year = ?, vo = ?, image_path = ? WHERE id = ?");
    if ($stmt->execute([$title, $client, $contract_sum, $completion_year, $completion_month, $status, $eot, $eot_number, $eot_month, $eot_year, $vo, $image_path, $id])) {
            ...
            <form action="edit-project.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="contract_sum" value="<?php echo htmlspecialchars($project['contract_sum'] ?? ''); ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            <input type="checkbox" name="vo" id="vo" <?php echo $project['vo'] == 1 ? 'checked' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="eot_number" value="<?php echo htmlspecialchars($project['eot_number'] ?? ''); ?>" placeholder="e.g., 1">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="eot_month">
                            ...
                            <?php
                            foreach ($months as $num => $month) {
                                $selected = ($project['eot_month'] == $num) ? 'selected' : '';
                                echo "<option value='$num' $selected>$month</option>";
                            }
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="eot_year">
                            ...
                            <?php
                            for ($y = 2012; $y <= $currentYear + 20; $y++) {
                                $selected = ($project['eot_year'] == $y) ? 'selected' : '';
                                echo "<option value='$y' $selected>$y</option>";
                            }
                            ?>
                        </select>
